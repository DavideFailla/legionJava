...
import static org.generation.italy.legion.model.data.HibernateConstants.HQL_FIND_BY_TITLE_LIKE_WHEN_ACTIVE_AND_MIN_EDITION;
import static org.generation.italy.legion.model.data.HibernateConstants.HQL_FIND_COURSE_BY_TITLE_LIKE_AND_MIN_EDITION;
...
public interface CourseRepository extends GenericRepository<Course>{
    ...
    @Query(HQL_FIND_BY_TITLE_LIKE_WHEN_ACTIVE_AND_MIN_EDITION)
